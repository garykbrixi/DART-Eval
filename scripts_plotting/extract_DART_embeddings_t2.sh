...
#SBATCH --job-name=DART_embedding_extraction_t2
...
cd $DNAGEN_DIR
python -m eval.DART-Eval.src.dnalm_bench.task_2_5_single.experiments.task_2_transcription_factor_binding.embeddings.evo
